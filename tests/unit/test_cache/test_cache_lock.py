...
@pytest.mark.asyncio
async def test_exclusive_lock_acquire_release(temp_dir):
...
@pytest.mark.asyncio
async def test_shared_lock_multiple_readers(temp_dir):
...
@pytest.mark.asyncio
async def test_exclusive_lock_blocks_other_exclusive(temp_dir):
...
@pytest.mark.asyncio
async def test_exclusive_lock_blocks_shared(temp_dir):
...
@pytest.mark.asyncio
async def test_shared_lock_blocks_exclusive(temp_dir):
...
@pytest.mark.asyncio
async def test_lock_creates_parent_directory(temp_dir):
...
@pytest.mark.asyncio
async def test_lock_sequential_acquisition(temp_dir):
...
@pytest.mark.asyncio
async def test_context_manager_exception_handling(temp_dir):
